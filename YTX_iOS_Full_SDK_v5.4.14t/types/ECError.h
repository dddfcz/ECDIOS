...
typedef NS_ENUM(NSInteger,ECErrorType) {
    ...
    /** 聊天室房间id为空 */
    ECErrorType_SDK_LiveChatRoomIdNull = 170101,
    
    /** 聊天室成员id为空*/
    ECErrorType_SDK_LiveChatRoomMemberIdNull = 170102,
    ...
    /** 聊天室禁言 */
    ECErrorType_LiveChatRoom_Forbid = 620006,
    
    /** 无网络等5秒发起重连 */
    ECErrorType_AppDelegate_Wait_Five_Sencod = 999997,
    
    /** 失败重连 */
    ECErrorType_AppDelegate_Wait = 999998,
};
